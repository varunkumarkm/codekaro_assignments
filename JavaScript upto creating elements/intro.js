...
//   // let button = document.getElementById('btn')
//   title.innerText = 'You are good to move advance topics'
//   let button = document.getElementById('btn').style.backgroundColor = 'blue'
...
// setTimeout(function, delay(is always miliseconds))
